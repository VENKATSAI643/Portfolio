    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://drive.google.com/file/d/1S0U-9eWkg6DhXl_Atlytp2PHUPBwH6BF/view?usp=sharing" target='blank'>Resume</Button>
                    <Button href="https://github.com/VENKATSAI643" target="blank">Github</Button>
