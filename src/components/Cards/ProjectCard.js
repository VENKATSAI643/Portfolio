...
const Description = styled.div`
    ...
    -webkit-box-orient: vertical;
    text-overflow: ellipsis;
    transition: max-height 0.5s ease-in-out, overflow 0.5s ease-in-out; /* Smooth transition */
...
const ProjectCards = ({ project }) => {
    ...
    return (
        <Card>
            <Image src={require(`../../images/${project.image}`)} alt={project.title} />
            <Tags>
